...
class DataLoader():
    ...
    def get_data(self, **kwargs):
        ...
        if data_type == 'movements':
            return Movements(data_loader = self, files=files)
        elif data_type == 'stations':
            return Stations(data_loader = self, files=files)
...
class Stations(Data):
    def __init__(self, **kwargs):
        ...
        self.schema = tp.StructType()\
                ...
                .add("stations", tp.ArrayType(\
                        tp.StructType()\
                            .add("activate", tp.BooleanType(), False)\
                            ...
                            .add("latitude", tp.FloatType(), False)\
                            .add("light", tp.IntegerType(), False)\
                            .add("longitude", tp.FloatType(), False)\

...
\begin{document}
	...
	\section{Grafo multifichero:}
		...
		linerange = {62-65},
		firstnumber = 62,
		caption = {[Grafo multifichero: mixed]unión de rdd}
		]{triciclos_mixed.py}
		...
		linerange = {32-40},
		firstnumber = 32,
		caption = {[Grafo multifichero: tag]tag}
		]{triciclos_mixed.py}
		...
		linerange = {20-20},
		firstnumber = 20,
		caption = {[Multiples grafos: función para distinguir grafos]Tuplemorph}
		]{indeplatex.py}
		\subsection{Triciclos}
		...
		linerange = {66-70},
		firstnumber = 66,
		caption = {[Multiples grafos: tricycles]tricycles}
		]{indeplatex.py}
